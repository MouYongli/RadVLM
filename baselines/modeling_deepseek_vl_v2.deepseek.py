...
class DeepseekVLV2Config(PretrainedConfig):
    ...
    @property
    def use_cache(self):
        """Delegate use_cache to language_config."""
        return self.language_config.use_cache
    
    @use_cache.setter
    def use_cache(self, value):
        """Delegate use_cache setter to language_config."""
        self.language_config.use_cache = value
