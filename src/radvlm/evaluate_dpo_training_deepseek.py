...
def evaluate_pre_training():
    ...
    model_path = os.path.abspath(os.path.join(here, "../../results/dpo/deepseek-vl2-mimic-cxr-dpo-lora-r16-lr5e-5-beta0.1-model23-5pctdataset-frommodel23-1e-2lambda/best_model"))
    ...
    output_file = '/pfss/mlde/workspaces/mlde_wsp_RWTH_MedReport/ag88juba/RadVLM/results/generated_reports/generated_reports_dpo-lora-r16-lr5e-5-beta0.1-model23-5pctdataset-frommodel23-1e-2lambda.txt'
