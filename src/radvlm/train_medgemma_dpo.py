...
class TrainingConfig:
    ...
    output_dir: str = (
        "/pfss/mlde/workspaces/mlde_wsp_RWTH_MedReport/ag88juba/RadVLM/results/dpo/medgemma-1.5-mimic-cxr-dpo-lora-r16-lr5e-5-beta0.1-model15-6pctdataset-frommodel8-1e-1lambda"
    )
    ...
    wandb_run:     str = (
        "medgemma-1.5-mimic-cxr-dpo-lora-r16-lr5e-5-beta0.1-model15-6pctdataset-frommodel8-1e-1lambda"
    )
...
def main():
    ...
    preference_data = load_preference_dataset(
        "/pfss/mlde/workspaces/mlde_wsp_RWTH_MedReport/ag88juba/RadVLM/results/dpo_dataset/medgemma-model8-6pctdatasetreports-1e-1lambda.json"
    )
