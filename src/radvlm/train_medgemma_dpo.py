...
class TrainingConfig:
    ...
    output_dir: str = (
        "/pfss/mlde/workspaces/mlde_wsp_RWTH_MedReport/ag88juba/RadVLM/results/dpo/medgemma-1.5-mimic-cxr-dpo-lora-r16-lr5e-5-beta0.1-model15-3pctdataset-frommodel8-5e-1lambda-discrete-processed"
    )
    ...
    wandb_run:     str = (
        "medgemma-1.5-mimic-cxr-dpo-lora-r16-lr5e-5-beta0.1-model15-3pctdataset-frommodel8-5e-1lambda-discrete-processed"
    )
...
def main():
    ...
    preference_data = load_preference_dataset(
        "/pfss/mlde/workspaces/mlde_wsp_RWTH_MedReport/ag88juba/RadVLM/results/dpo_dataset/medgemma-model8-3pctdatasetreports-5e-1lambda-discrete-processed.json"
    )
