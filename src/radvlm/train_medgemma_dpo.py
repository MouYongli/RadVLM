...
class TrainingConfig:
    ...
    output_dir: str = (
        "/pfss/mlde/workspaces/mlde_wsp_RWTH_MedReport/ag88juba/RadVLM/results/dpo/medgemma-1.5-mimic-cxr-dpo-lora-r16-lr5e-5-beta0.1-model15-deepseek-dataset-large-1e-2lambda"
    )
    ...
    wandb_run:     str = (
        "medgemma-1.5-mimic-cxr-dpo-lora-r16-lr5e-5-beta0.1-model15-deepseek-dataset-large-1e-2lambda"
    )
...
def main():
    ...
    preference_data = load_preference_dataset(
        "/pfss/mlde/workspaces/mlde_wsp_RWTH_MedReport/ag88juba/RadVLM/results/dpo_dataset/model23-10pctdatasetreports-1e-2lambda-discrete-processed-corrected-sampling.json"
    )
