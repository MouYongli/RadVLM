...
def evaluate_pre_training():
    ...
    model_path = os.path.abspath(os.path.join(here, "../../results/dpo/medgemma-1.5-mimic-cxr-dpo-lora-r16-lr5e-5-beta0.1-model15-6pctdataset-frommodel8-1e-2lambda-discrete/best_model"))
    ...
    output_file = '/pfss/mlde/workspaces/mlde_wsp_RWTH_MedReport/ag88juba/RadVLM/results/generated_reports/generated_reports_dpo-lora-r16-lr5e-5-beta0.1-model15-6pctdataset-frommodel8-1e-2lambda-discrete.txt'
