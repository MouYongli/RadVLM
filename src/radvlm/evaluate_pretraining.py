...
def evaluate_pre_training():
    ...
    output_file = '/pfss/mlde/workspaces/mlde_wsp_RWTH_MedReport/ag88juba/RadVLM/results/generated_reports/generated_reports_lora-r8-lr1e-4-3epochs-linear-5pctwarmup-3earlystop-100pct-final.txt'
