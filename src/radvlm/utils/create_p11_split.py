...
if __name__ == "__main__":
    json_path = "/pfss/mlde/workspaces/mlde_wsp_RWTH_MedReport/ag88juba/RadVLM/results/dpo_dataset/medgemma-model8-3pctdatasetreports-1e-2lambda.json"
    output_path = "/pfss/mlde/workspaces/mlde_wsp_RWTH_MedReport/ag88juba/RadVLM/results/dpo_dataset/split-medgemma-model8-3pctdatasetreports.csv"
