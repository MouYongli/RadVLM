...
def create_radgraph_preferences_medgemma(preference_dataset_path, output_path):
    """
    Create RadGraph preferences for MedGemma evaluation dataset.
...
if __name__ == "__main__":
    preference_dataset_path = "/pfss/mlde/workspaces/mlde_wsp_RWTH_MedReport/ag88juba/RadVLM/results/dpo_dataset/medgemma-generated-report-pairs.json"
    output_path = "/pfss/mlde/workspaces/mlde_wsp_RWTH_MedReport/ag88juba/RadVLM/results/dpo_dataset/medgemma_radgraph_preferences.json"
